...
module.exports = {
    name: 'sendembed',
    description: 'Sends an embed via webhook and forwards it to the target channel.',
    async execute(client, message, args, settings) {
        ...
        // Create embed
        const embed = {
            title: args[0] || settings.embedDefaults.title,
            description: args[1] || settings.embedDefaults.description,
            color: parseInt(args[2] || settings.embedDefaults.color),
            fields: [
                { name: settings.embedDefaults.field1, value: args[3] || settings.embedDefaults.field1Text, inline: true },
                { name: settings.embedDefaults.field2, value: settings.embedDefaults.field2Text, inline: true }
            ],
