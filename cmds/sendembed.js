...
module.exports = {
    ...
    async execute(client, message, args, settings) {
        ...
        // Create embed
        const embed = {
            title: settings.embedDefaults.title,
            description: settings.embedDefaults.description,
            color: parseInt(settings.embedDefaults.color),
            fields: [
                { name: settings.embedDefaults.field1, value: settings.embedDefaults.field1Text, inline: true },
